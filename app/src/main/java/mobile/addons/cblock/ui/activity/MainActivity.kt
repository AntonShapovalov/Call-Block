...
import mobile.addons.cblock.ext.*
...
import mobile.addons.cblock.ui.view.perm.PermFragment
import mobile.addons.cblock.ui.view.perm.PermViewModel
...
class MainActivity : AppCompatActivity(), IMainListener {
    ...
    private val permissionsRequest = 311
    ...
    private fun requestPermissions() {
        ...
        when {
            ...
            perm.request.isNotEmpty() -> ActivityCompat.requestPermissions(this, perm.request, permissionsRequest)
            else -> initComponents()
        }
    }
